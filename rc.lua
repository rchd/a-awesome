--[[
kwesome WM configuration template
github.com/lcpz
--]]
...
--awful.key({ altkey }, "p", function() os.execute("spectacle -f -b -s -n") end,
...
awful.key({ "Shift"}, "space", function ()
    ...
    --os.execute("export QT_QPA_PLATFORMTHEME=kde | rofi -combi-modi window,drun -show combi -modi combi ")
end,
